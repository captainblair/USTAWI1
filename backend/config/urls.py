...
from apps.analytics.urls.analytics import urlpatterns as analytics_urlpatterns
...
# Serve uploaded media in production (Render local disk). Use S3/Cloudinary at scale.
