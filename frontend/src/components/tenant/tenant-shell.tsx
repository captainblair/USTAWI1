    ...
    <div className="min-h-screen overflow-x-hidden bg-[#F7F8FC] lg:flex">
      ...
      >
        <div className="flex h-16 items-center justify-between px-5">
          <Link href="/dashboard" className="text-lg font-bold tracking-[0.06em]">
            USTAWI
          </Link>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-[#E8EAF2] bg-white px-4 sm:px-6">
          ...
          <div className="relative hidden max-w-md flex-1 sm:block">
            ...
            <Link
              href="/properties"
              className="flex h-10 w-full items-center rounded-full border border-[#E8EAF2] bg-[#F7F8FC] pl-10 pr-4 text-sm text-ustawi-muted hover:border-ustawi-navy/20"
            >
              Search properties
            </Link>
          </div>
