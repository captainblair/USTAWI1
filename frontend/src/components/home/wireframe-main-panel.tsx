    ...
    >
      ...
      <div className="space-y-1 p-4">
        <div className="flex items-start gap-1.5">
          ...
          <p className="text-sm font-semibold text-ustawi-navy">{title}</p>
        </div>
      ...
      <ScrollReveal variant="fade-up">
        ...
        <div className="px-4 pb-6 pt-5">
          ...
          <ul className="mt-5 space-y-3">
            {SAMPLE_PROPERTIES.map((item, i) => (
              <ScrollReveal key={item.id} variant="slide-right" delay={i * 0.08}>
              <li>
                <Link
                  href="/properties"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 p-8 pb-0">
              {STEPS.map((step, i) => (
                ...
                <div
                  className="group relative overflow-hidden rounded-xl border border-ustawi-border/60 bg-ustawi-cream p-5 transition hover:border-ustawi-red/20 hover:shadow-soft"
                >
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-3 gap-5">
                {SAMPLE_PROPERTIES.map((p, i) => (
                  <ScrollReveal key={p.id} variant="fade-up" delay={i * 0.12}>
                  <PropertyCard
                    title={p.title}
                    subtitle={p.subtitle}
                    price={p.price}
              ...
              <div id="featured-properties" className="mt-10 scroll-mt-28">
                ...
                <div className="grid grid-cols-3 gap-5">
                  {featuredCards.map((p, i) => (
                    <ScrollReveal key={p.title + p.price} variant="fade-up" delay={i * 0.12}>
